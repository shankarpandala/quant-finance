...
const CONTENT_REGISTRY = {
  ...
  '08-backtesting/c3-event-driven-backtesting/s3-custom-framework': lazy(() => import('../subjects/08-backtesting/c3-event-driven-backtesting/s3-custom-framework.jsx')),
  '08-backtesting/c4-walk-forward/s1-walk-forward-analysis': lazy(() => import('../subjects/08-backtesting/c4-walk-forward/s1-walk-forward-analysis.jsx')),
  '08-backtesting/c4-walk-forward/s2-purged-cv': lazy(() => import('../subjects/08-backtesting/c4-walk-forward/s2-purged-cv.jsx')),
  '08-backtesting/c4-walk-forward/s3-monte-carlo-validation': lazy(() => import('../subjects/08-backtesting/c4-walk-forward/s3-monte-carlo-validation.jsx')),
  '08-backtesting/c5-simulation/s1-synthetic-data': lazy(() => import('../subjects/08-backtesting/c5-simulation/s1-synthetic-data.jsx')),
  '08-backtesting/c5-simulation/s2-agent-based-simulation': lazy(() => import('../subjects/08-backtesting/c5-simulation/s2-agent-based-simulation.jsx')),
  ...
  '13-deep-learning-trading/c4-generative-finance/s3-diffusion-finance': lazy(() => import('../subjects/13-deep-learning-trading/c4-generative-finance/s3-diffusion-finance.jsx')),
  '13-deep-learning-trading/c5-deep-hedging/s1-deep-hedging': lazy(() => import('../subjects/13-deep-learning-trading/c5-deep-hedging/s1-deep-hedging.jsx')),
  '13-deep-learning-trading/c5-deep-hedging/s2-neural-sde': lazy(() => import('../subjects/13-deep-learning-trading/c5-deep-hedging/s2-neural-sde.jsx')),
